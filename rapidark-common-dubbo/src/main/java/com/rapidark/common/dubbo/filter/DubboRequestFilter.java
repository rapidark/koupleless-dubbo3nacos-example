package com.rapidark.common.dubbo.filter;

import cn.hutool.extra.spring.SpringUtil;
import com.rapidark.common.dubbo.enumd.RequestLogEnum;
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        if (result.hasException() && invoker.getInterface().equals(GenericService.class)) {
            ...
            if (properties.getLogLevel() == RequestLogEnum.INFO) {
                ...
                log.info("DUBBO - 服务响应: {},SpendTime=[{}ms],Response={}", baselog, elapsed, result.getValue());
            }
        }
        return result;
    }
